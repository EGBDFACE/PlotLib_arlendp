(function (global, factory) {
    ...
    function draw(node, point) {
        ...
        if (drawer === false) return;
            ...
            //
            // Stroke
            stroke = {color: color2hex(node.getValue('stroke')), alpha: node.getValue('stroke-opacity')};
            ...
            //
            // Fill
            fill = {color: color2hex(node.getValue('fill')), alpha: node.getValue('fill-opacity')};
