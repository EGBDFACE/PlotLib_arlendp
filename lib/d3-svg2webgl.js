(function (global, factory) {
    ...
    var transform = function (node) {
        ...
        transResult = getTrans(x, y, sx, sy, trans);
        x = transResult.x;
        y = transResult.y;
        sx = transResult.sx;
        sy = transResult.sy;
    ...
    function getTrans(x, y, sx, sy, trans) {
    ...
    function draw(node, point) {
        ...
        if (drawer === false) return;
            ...
            // Fill
            fill = {
                color: color2hex((node.getValue('fill') === 'none' ? undefined : node.getValue('fill')) || '#000'),
                alpha: node.getValue('fill-opacity')
            };
